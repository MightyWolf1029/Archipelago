...
class OOTLogic(LogicMixin):
    """
    A class containing logic helper functions for AP.
    """
...
def set_rules(ootworld):
    """
    Helper function to set rules. Modified to use ``ootworld``.
...
def create_shop_rule(location, parser):
    """
    Helper function to create the shop rule. Modified to use the parser from ``ootworld``
    """
...
def set_shop_rules(ootworld):
    """
    Helper function to set the shop rules. Modified to use ``ootworld``.
...
def set_entrances_based_rules(ootworld):
    """
    Helper function to set the entrance-based rules. Modified to use ``ootworld``.
